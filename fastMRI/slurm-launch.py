...
template_file = Path(os.path.dirname(__file__)) / "slurm-template.sh"
JOB_NAME = "${JOB_NAME}"
NUM_NODES = "${NUM_NODES}"
...
if __name__ == "__main__":
    ...
    job_name = "{}_{}".format(args.exp_name, time.strftime("%Y%m%d-%H%M", time.localtime()))
    ...
    # ===== Save the script =====
    script_file = "./slurm_log/"+"{}.sh".format(job_name)
